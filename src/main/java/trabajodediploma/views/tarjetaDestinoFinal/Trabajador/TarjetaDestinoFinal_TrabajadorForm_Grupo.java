 ...
 * @author leinier
 */
public class TarjetaDestinoFinal_TrabajadorForm_Grupo extends FormLayout {
    ...
    public TarjetaDestinoFinal_TrabajadorForm_Grupo(List<Area> areas, List<Trabajador> trabajadors, List<Modulo> modulos) {
    ...
    private HorizontalLayout createButtonsLayout() {
        ...
        close.addClickListener(event -> fireEvent(new TarjetaDestinoFinal_TrabajadorForm_Grupo.CloseEvent(this)));
    ...
    private void validateAndSave() {
        try {
            ...
            fireEvent(new TarjetaDestinoFinal_TrabajadorForm_Grupo.SaveEvent(this, tarjeta));
    ...
    // Events
    public static abstract class DestinoFinalTrabajadorFormEvent extends ComponentEvent<TarjetaDestinoFinal_TrabajadorForm_Grupo> {

        private DestinoFinalTrabajador destinoFinal;

        protected DestinoFinalTrabajadorFormEvent(TarjetaDestinoFinal_TrabajadorForm_Grupo source, DestinoFinalTrabajador DestinoFinal) {
            super(source, false);
    ...
    public static class SaveEvent extends DestinoFinalTrabajadorFormEvent {
        ...
        SaveEvent(TarjetaDestinoFinal_TrabajadorForm_Grupo source, DestinoFinalTrabajador DestinoFinal) {
    ...
    public static class DeleteEvent extends DestinoFinalTrabajadorFormEvent {
        ...
        DeleteEvent(TarjetaDestinoFinal_TrabajadorForm_Grupo source, DestinoFinalTrabajador DestinoFinal) {
            super(source, DestinoFinal);
        }
    ...
    public static class CloseEvent extends DestinoFinalTrabajadorFormEvent {
        ...
        CloseEvent(TarjetaDestinoFinal_TrabajadorForm_Grupo source) {
            super(source, null);
        }
    }
